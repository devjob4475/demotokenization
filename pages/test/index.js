        ...
        <Box sx={{display:'flex',ml:3,mb:-0.5}}>
          ...
          <Box sx={{p:5,width: "auto",height: "auto",flexShrink: 0,borderRadius:"30px",background:"#fff",boxShadow:"0px 13px 68px 0px rgba(0, 0, 0, 0.13),",overflow: "hidden",}}>
            ...
            <table key={`${index}`} className="gfg">
                ...
                <Box>
                <ListItemButton onClick={handleToggleCollapse} sx={{ display: 'flex', alignItems: "center", justifyContent: "flex-start", width: '200px' }}>
                  ...
                  <List component="div" disablePadding>
                    <ListItemButton>
                      ...
                      <Typography component="div" variant="body2">
                        <strong>Name</strong> {showMaskAccount ? showPasswordAcount ? `${user.FirstnameOriginal} ${user.SurnameOriginal}` : `${user.Firstname} ${user.Surname}` : '********'}
                      </Typography>
                      </TableCell>
               ...
               <Box ml={-0.5} display="flex" alignItems="center" justifyContent="flex-start" >
                ...
                <IconButton onClick={handleClickShowPasswordAccount} sx={{ mt: 1 }} color="inherit">
                  {setShowPasswordAccount ? <VisibilityIcon /> : <VisibilityOffIcon />}
                </IconButton>
