...
function Index() {
  ...
  console.log("🚀 ~ file: index.js:17 ~ Index ~ company:", company)
      ...
      <Box sx={{background:`linear-gradient(${themedata[0].primary}, ${themedata[0].three})`,height:"100vh",width:'100%'}}>
        ...
        transform: 'translate(-50%, -50%)'}}> 
          ...
          <Select value={company} label="Company" onChange={handleChange}>
            ...
            <MenuItem value={state.company_name_en}>{state.company_name_en}</MenuItem>
            <MenuItem value={'company2'}>No!</MenuItem>
          </Select>
        </FormControl>
        </Box>
